  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    private void reduceHeight() {
    	...
    	int[] sequence = findKeyInsertionSequence();
    	for (int i: sequence) {
    ...
    private int[] findKeyInsertionSequence() {
        ...
        int q2=sequence.length/2;
        int q1=sequence.length/4;
        int q3=sequence.length*3/4;
     
	    sequence[0]=q2;                                   //將非q1,q2,q3 25,50,75 取q1,q2,q3百分位數
	    sequence[1]=q1;
	    sequence[2]=q3;
        int index = 0;
	    for(int k=3;k<sequence.length;k++) {
	       if(index==q1 || index==q2 || index==q3) {      //排除index是q1,q2,q3百分位數的索引值的情況
	          index+=1;                                   //索引值+1
	       }
	       sequence[k]=index;                             //將非q1,q2,q3的index擺放進sequence當中
	       index+=1;                                      //index+1
	     }
    ...
    private void showImprovement(int height1, int height2) {
    	System.out.println("Improvement: " + String.format("%.2f", 100*(height1-height2)/(double)height1) + "%");
    	System.out.println();
    }
    ...
    public static void main(String[] args) { 
        ...
        st.printKeysInorder();
        st.showImprovement(originalHeight, newHeight);
        
        BST1<String, Integer> st2 = new BST1<String, Integer>();
        st2.put("A", 1);
        st2.put("B", 1);
        st2.put("C", 1);
        st2.put("D", 1);
        ...
        System.out.println("New height: " + newHeight);
        st2.printKeysInorder();
        st2.showImprovement(originalHeight, newHeight);
